...
<body>
  <ul class="topnav container-fluid" style="margin-bottom: 0px;">
    ...
    <div class="inner">
      ...
      <li><a href="daftar.php"><strong>Daftar</strong></a></li>
  ...
  <div class="container box mt-4">
    <div class="card-body">
      <div class="alert" style=" background-color: #1E4478;">
        <h3 class=" text-center">Pendaftaran vaksinasi</h3>
      </div>

      <form method="POST" action="">
        <input type="hidden" name="no_antrian" value=">">
        <div class="form-group row mb-2">
          <label class="col-md-2" for="nik">NIK</label>
          <div class="col-md-10">
            <input type="text" class="form-control " id="nik" placeholder="Masukkan NIK" name="nik" value="" required>
          </div>
        </div>
        <div class="form-group row mb-2">
          <label class="col-md-2" for="nama">Nama Lengkap</label>
          <div class="col-md-10">
            <input type="text" class="form-control " id="nama" placeholder="Masukkan Nama" name="nama" value="" required>
          </div>
        </div>
        ...
        <div class="form-group row mb-2">
          ...
          <div class="col-md-10">
            <input type="text" class="form-control " id="no_telp" name="no_telp" placeholder="Masukkan No.HP" value="" required>
